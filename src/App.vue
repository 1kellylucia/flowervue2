<template>
  <div id="app">
    <b-navbar toggleable="md" variant="dark" type="dark">
      ...
      <b-navbar-brand to="/">flower store Web App</b-navbar-brand>
      <b-collapse is-nav id="nav_collapse">
        <b-navbar-nav>
          <b-nav-item to="/#"><i class="fa fa-home" style="padding: 5px">Home</i></b-nav-item>
          <b-nav-item to="/flowers"><i class="fa fa-list" style="padding: 5px"> Manage Flowers</i></b-nav-item>
          <b-nav-item data-test="flowerbtn" to="/addflowers"><i class="fa fa-star" style="padding: 5px"> Add Flower</i></b-nav-item>
